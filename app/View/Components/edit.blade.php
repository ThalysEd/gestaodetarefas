                ...
                <form action="{{ route('tasks.update', $task) }}" method="POST">
                    ...
                    <div class="mb-4">
                        <label class="inline-flex items-center">
                            <input type="checkbox" name="is_completed" value="1" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" @checked(old('is_completed', $task->is_completed)) />
                            <span class="ml-2 text-sm text-gray-600">Concluída?</span>
                        </label>
                    </div>
